...
import { XCircle, HelpCircle, MessageCircle, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 py-20">
      <div className="max-w-md w-full text-center">
        ...
        <div className="bg-slate-800 rounded-lg p-6 mb-8 text-left border border-slate-700">
        ...
        <div className="space-y-3">
          <Link 
            to="/" 
            className="block bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold py-3 rounded-lg transition flex items-center justify-center gap-2"
          >
            <ArrowLeft size={18} />
            Return to Home
          </Link>
